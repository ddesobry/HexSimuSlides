...
\begin{frame}
    ...
    \only<2>{
        ...
        \begin{minipage}{.49\linewidth}
            \centering
            \includegraphics[angle=90, width=\linewidth]{img/new_images/bestpaperSPM2021.jpg}
            \vspace*{1em}
        ...
        \begin{minipage}{.49\linewidth}
            \centering
            \includegraphics[width=\linewidth]{img/new_images/factuel_hashcode.PNG}
            Google Hash Code : $16^{\text{ème}}$\\
